    ...
    <div class="bg-white rounded-lg p-4">
      <form class="space-y-8 divide-y divide-gray-200">
        <div class="space-y-8 divide-y divide-gray-200">
          <div>
            <div>
              <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Movie</h3>
  ...
  data() {
    return {
      breadcrumbData: [
        ...
        { name: 'Add Movie', href: '/movies/add', current: false },
        { name: this.$route.params.id, href: `/movies${this.$route.params.id}`, current: true }
      ],
      draggableCasts: [
        {
          name: "John Doe",
